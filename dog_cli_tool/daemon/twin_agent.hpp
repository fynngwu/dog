...
class TwinAgent {
public:
    explicit TwinAgent(int cmd_port = 47001);
    ~TwinAgent();
...
private:
    ...
    bool StartReplayMotion(const std::string& csv_path, float speed_factor, std::string& err, bool skip_feedback_check = false);
